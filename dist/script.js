...
var titleTable = ["Renglon", "Nombre", "Edad", "Correo", "Github", "", ""];
var data = [];
function buildTable(titleTable, data) {
  var tableBorrar = document.getElementById("miTabla");
  if (tableBorrar !== null) {
    document.getElementById("mountains").removeChild(tableBorrar);
  }
  ...
  for (var _i = 0; _i < data.length; _i++) {
    ...
    var _loop = function _loop(j) {
      ...
      if (j == 5) {
        ...
        button.id = "btnBorrar" + Number(_i + 1);
        ...
        button.id = "btnEditar" + Number(_i + 1);
        button.addEventListener("click", function (event) {
          event.preventDefault();
          renglonBorrar = Number(this.id.slice(9));
        ...
        tCell.appendChild(document.createTextNode(data[_i][titleTable[j]]));
      } else if (j == 4) {
        getUrl(data[_i][titleTable[1]]).then(function (user) {
          var ligaGit = document.createTextNode(user);
          if (user != "Sin cuenta") {
...
btnSubir.addEventListener("submit", function (event) {
  ...
  if (document.getElementById("btnSubir").innerHTML == "Modificar") {
    var rowModified = Number(document.getElementById("btnSubir").name);
...
function fetchGH(_x) {
  return _fetchGH.apply(this, arguments);
}
function _fetchGH() {
  _fetchGH = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(countGit) {
    var urlGit, response, countUserGit;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            urlGit = "";
            _context.next = 3;
            return fetch('https://api.github.com/users/' + countGit, {
              headers: {
          ...
          case 6:
            countUserGit = _context.sent;
            if (countUserGit.message != undefined) {
              urlGit = "Sin cuenta";
            } else {
              urlGit = countUserGit.html_url;
            }
            return _context.abrupt("return", urlGit);
          case 9:
          case "end":
...
function _getUrl() {
  _getUrl = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(countGit2) {
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return fetchGH(countGit2);
          case 2:
